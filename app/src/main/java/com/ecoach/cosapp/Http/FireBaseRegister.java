...
public class FireBaseRegister extends IntentService {
    ...
    public FireBaseRegister(String name) {
        super(name);
    }
    public FireBaseRegister() {
        super("FireBaseRegister");
    }


    @Override
    protected void onHandleIntent(Intent intent) {
        Log.d("result","fireBase Registration started") ;
        ...
        try {
            ...
            loadRepInviteVolley(refreshToken);
            Log.d("result","fireBase Application.getFireBaseToken  : " + refreshToken ) ;
    ...
    private void loadRepInviteVolley(String fcm_token){
