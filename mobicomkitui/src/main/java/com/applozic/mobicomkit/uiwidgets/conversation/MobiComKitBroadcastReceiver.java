...
public class MobiComKitBroadcastReceiver extends BroadcastReceiver {
    ...
    public MobiComKitBroadcastReceiver(FragmentActivity fragmentActivity, MobiComQuickConversationFragment mobiComQuickConversationFragment) {
        this.conversationUIService = new ConversationUIService(fragmentActivity,mobiComQuickConversationFragment);  this.baseContactService = new AppContactService(fragmentActivity);
    }
    @Override
